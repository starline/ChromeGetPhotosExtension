...
- В разделе assets лежати все изображения и иконки, css файлы
- В разделе src лежит весь исходный код расширения
- В разделе teplates лежат html шаблоны для popup и options страницы
- В корне проекта лежат файлы манифеста и конфигурации сборки
- В файле README.md лежит документация по установке и использованию расширения, дополнять документацию по мере развития функционала
